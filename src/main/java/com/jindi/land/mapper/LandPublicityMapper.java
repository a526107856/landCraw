...
public interface LandPublicityMapper {
  ...
  @Insert(
      "insert ignore into `prism_cq`.`land_publicity_20190611`(`title`,`administrative_district`, `land_num`, `land_location`, `land_usefulness`, `land_area`, `project_name`, `land_use_right_person`, `landuser_clean`,`remark`, `public_announcement_period`, `feedback_method`, `contact_organize`, `organize_location`, `postal_code`, `contact_number`, `contact_person`, `electronic_mail`, `publication_organize`, `publication_date`, `chain_link`, `url`,`final_price`,`transfer_period`,`publication_end_date_clean`,`publication_start_date_clean`,`index`,`html`) "
